...
The numbered Caffeine DDRs from `bamm-e-commerce-site` (DDR-001 Admin Roles through DDR-032, etc.) remain in this tree as historical reference from baseline **`v133.0.17`**. They describe the Caffeine production system. **Do not** treat Caffeine deploy locks (DDR-021/026/027) as constraints on this dfx repo.
